...
export class ListBlogComponent implements OnInit {
  ...
  constructor(
    private listBlogResolver: ListBlogResolver
  ) {
   ...
   */
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.listBlogResolver, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
    ...
    this.filteredData = this.listBlogResolver.blogs;
  }
  ...
  connect(): Observable<any[]> {
    const displayDataChanges = [
      this.listBlogResolver.onBlogsChanged,
    ...
    return merge(...displayDataChanges)
      .pipe(
        map(() => {
          let data = this.listBlogResolver.blogs.slice();
    ...
    return data.sort((a, b) => {
      ...
      switch (this.matSort.active) {
        ...
        case 'name':
          ...
          break;
        case 'blogs':
          [propertyA, propertyB] = [a.blogs[0], b.blogs[0]];
          break;
        case 'price':
