...
export class ListZoneComponent implements OnInit {
  ...
  constructor(
    private listZoneResolver: ListZoneResolver
  ) {
   ...
   */
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.listZoneResolver, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
    ...
    this.filteredData = this.listZoneResolver.zones;
  }
  ...
  connect(): Observable<any[]> {
    const displayDataChanges = [
      this.listZoneResolver.onZonesChanged,
    ...
    return merge(...displayDataChanges)
      .pipe(
        map(() => {
          let data = this.listZoneResolver.zones.slice();
    ...
    return data.sort((a, b) => {
      ...
      switch (this.matSort.active) {
        ...
        case 'name':
          ...
          break;
        case 'zones':
          [propertyA, propertyB] = [a.zones[0], b.zones[0]];
          break;
        case 'price':
