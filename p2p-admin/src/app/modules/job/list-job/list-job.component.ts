...
export class ListJobComponent implements OnInit {
  ...
  constructor(
    private listJobResolver: ListJobResolver
  ) {
   ...
   */
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.listJobResolver, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
    ...
    this.filteredData = this.listJobResolver.jobs;
  }
  ...
  connect(): Observable<any[]> {
    const displayDataChanges = [
      this.listJobResolver.onJobsChanged,
    ...
    return merge(...displayDataChanges)
      .pipe(
        map(() => {
          let data = this.listJobResolver.jobs.slice();
    ...
    return data.sort((a, b) => {
      ...
      switch (this.matSort.active) {
        ...
        case 'name':
          ...
          break;
        case 'jobs':
          [propertyA, propertyB] = [a.jobs[0], b.jobs[0]];
          break;
        case 'price':
