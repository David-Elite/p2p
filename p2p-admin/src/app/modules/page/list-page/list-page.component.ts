...
export class ListPageComponent implements OnInit {
  ...
  constructor(
    private listPageResolver: ListPageResolver
  ) {
   ...
   */
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.listPageResolver, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
    ...
    this.filteredData = this.listPageResolver.pages;
  }
  ...
  connect(): Observable<any[]> {
    const displayDataChanges = [
      this.listPageResolver.onPagesChanged,
    ...
    return merge(...displayDataChanges)
      .pipe(
        map(() => {
          let data = this.listPageResolver.pages.slice();
    ...
    return data.sort((a, b) => {
      ...
      switch (this.matSort.active) {
        ...
        case 'name':
          ...
          break;
        case 'pages':
          [propertyA, propertyB] = [a.pages[0], b.pages[0]];
          break;
        case 'price':
