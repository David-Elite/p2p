...
export class ListReviewComponent implements OnInit {
  ...
  displayedColumns = ['reviewTitle', 'image', 'packageName', 'reviewPoints', 'reviewerName'];
  ...
  constructor(
    private listReviewResolver: ListReviewResolver
  ) {
   ...
   */
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.listReviewResolver, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
   ...
   * Constructor
   *
   * @param {ReviewsService} ReviewService
  ...
  constructor(
    ...
    this.filteredData = this.listReviewResolver.reviews;
  }
  ...
  connect(): Observable<any[]> {
    const displayDataChanges = [
      this.listReviewResolver.onReviewsChanged,
    ...
    return merge(...displayDataChanges)
      .pipe(
        map(() => {
          let data = this.listReviewResolver.reviews.slice();
    ...
    return data.sort((a, b) => {
      ...
      switch (this.matSort.active) {
        ...
        case 'name':
          ...
          break;
        case 'reviews':
          [propertyA, propertyB] = [a.reviews[0], b.reviews[0]];
          break;
        case 'price':
