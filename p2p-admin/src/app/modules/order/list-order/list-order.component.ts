...
export class ListOrderComponent implements OnInit {
  ...
  displayedColumns = ['customerId', 'customerName', 'packageName', 'orderDate'];
  ...
  constructor(
    private listOrderResolver: ListOrderResolver
  ) {
   ...
   */
  ngOnInit(): void {
    this.dataSource = new FilesDataSource(this.listOrderResolver, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
  ...
  constructor(
    ...
    this.filteredData = this.listOrderResolver.orders;
  }
  ...
  connect(): Observable<any[]> {
    const displayDataChanges = [
      this.listOrderResolver.onOrdersChanged,
    ...
    return merge(...displayDataChanges)
      .pipe(
        map(() => {
          let data = this.listOrderResolver.orders.slice();
    ...
    return data.sort((a, b) => {
      ...
      switch (this.matSort.active) {
        ...
        case 'name':
          ...
          break;
        case 'orders':
          [propertyA, propertyB] = [a.orders[0], b.orders[0]];
          break;
        case 'price':
